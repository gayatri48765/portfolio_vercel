...
const SocialLinks = () => {
  return (
    <div className="flex justify-evenly space-x-4">
      ...
      <i className="fa-brands fa-linkedin fa-lg xs:fa-2xl"></i>
      </a>
      <a href="mailto:gayatrim22.gm@gmail.com" className="text-2xl text-gray-800 hover:text-primary-dark">
      <i className="fa-solid fa-envelope fa-lg xs:fa-2xl"></i>
      </a>
      ...
      <i className="fa-brands fa-github fa-lg xs:fa-2xl"></i>
      </a>
    </div>
  );
};
